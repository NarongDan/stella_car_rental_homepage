...
export default function HomePageBody() {
  ...
  return (
    <>
      ...
      {/* Testimonial */}
      <div
        className={`flex justify-center mt-16 dark:text-black transition-opacity duration-1000 ${
          isVisibleTestimonial ? "opacity-100" : "opacity-0"
        }`}
        ref={testimonialRef}
      >
      ...
      <div
        className={`flex justify-center p-5 transition-opacity duration-1000 ${
          isVisibleHow ? "opacity-100" : "opacity-0"
        }`}
        ref={howRef}
      >
        <div className="container">
